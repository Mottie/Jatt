...
g+";"});f=c}}return[a,f]};(function(){var f=d.live?"live":"bind";b("."+d.tooltip)[f](d.activate,function(h){var c=b(this),e=d.metadata.toString()=="false"?[d,""]:b.jatt.getMeta(c);a=e[0];var g=c.attr(a.content)===""?c.data("tooltip")||"":c.attr(a.content)||"",m=c.attr("rel")||"",j=c.attr("href")||"";c.data("tooltip",g);a.content=="title"&&c.attr(a.content,"");if(g==="")if(m!=="")g=b(m).html()||"No tooltip found";else if(j!==""){g="Loading...";b("body").append('<div id="ttloader"></div>');var i=b("#ttloader");
i.load(j,function(){b("#"+d.tooltip).html(i.html());c.data("tooltip",i.html());i.remove()})}e='<div id="'+d.tooltip+'" style="position:absolute;z-index:'+a.zIndex+";"+e[1]+'">'+g+"</div>";a.local?c.before(e):b("body").append(e);b.jatt.ttrelocate(h,"#"+d.tooltip);b("#"+d.tooltip).fadeIn(a.speed)})[f](d.deactivate,function(){b("#"+d.tooltip).remove()})[f]("mousemove",function(h){a.followMouse&&b.jatt.ttrelocate(h,"#"+d.tooltip)});b("a."+d.preview+", a."+d.screenshot)[f](d.activate,function(h){var c=
...
this.href+'" />';e+=g+"</div>";a.local?c.before(e):b("body").append(e);b("#"+d.preview).data("options",a);b.jatt.ttrelocate(h,"#"+d.preview);b("#"+d.preview).fadeIn(a.speed)})[f](d.deactivate,function(){b("#"+d.preview).remove()})[f]("mousemove",function(h){a.followMouse&&b.jatt.ttrelocate(h,"#"+d.preview)})})()};b.jatt.defaultOptions={direction:"n",followMouse:true,content:"title",speed:300,local:false,xOffset:20,yOffset:20,zIndex:1E3,live:false,metadata:"class",activate:"mouseenter focusin",deactivate:"mouseleave focusout",
